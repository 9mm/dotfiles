...
-- make ruby-lsp work with textDocument/diagnostic until 0.10 comes out
-- https://github.com/neovim/neovim/issues/22838
-- https://github.com/neovim/nvim-lspconfig/pull/2498
local _timers = {}
local function ruby_setup_diagnostics(client, buffer)
...
return {
  ...
  config = function()
    ...
    local on_attach = function(client, bufnr)
      if client.name == 'ruby' then
        ruby_setup_diagnostics(client, bufnr)
      end
